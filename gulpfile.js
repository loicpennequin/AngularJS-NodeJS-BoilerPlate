...
gulp.task('default', (cb) => {
  runSequence('clean', 'html', 'sass', 'js', 'server', 'open', 'watch', cb);
});
...
gulp.task('component', ()=>{
  ...
  fs.appendFileSync(config.paths.baseSrc + `modules/${moduleName}/${moduleName}.sass`, `@import './components/${componentName}/${componentName}.component.sass'`);
